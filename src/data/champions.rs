...
pub const CHAMPIONS_REFERENCE_SETS: &[ChampionReferenceSet] = &[
    ...
    ChampionReferenceSet {
        pokemon: "Blastoise",
        name: "Mega Attacker under Tailwind",
        stat_points: StatTable::new(2, 0, 0, 32, 0, 32),
        nature: Nature::Modest,
        ability: Ability::RainDish,
        item: Item::Blastoisinite,
        moves: ["Water Spout", "Aura Sphere", "Dark Pulse", "Ice Beam"],
    },
    ChampionReferenceSet {
        pokemon: "Raichu",
    ...
    ChampionReferenceSet {
        ...
        moves: ["Hyper Voice", "Psyshock", "Psychic", "Trick Room"],
    },
    ChampionReferenceSet {
        pokemon: "Gardevoir",
        name: "Timid Scarf",
